    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          py: 2,
          width: "100vw",
          mx: "calc(50% - 50vw)", // force full width across viewport
          textAlign: "center",
        }}
      >
        <Typography fontSize={14} fontWeight={600}>
          Copyright © 2025 <strong>Biltoz.com</strong> — All rights reserved to{" "}
          <strong>Aayog Logistic Private Limited.</strong>
        </Typography>
      </Box>
    </Box>
  );
