...
const OrderdetailsForm = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/order/${id}`) // Replace with your API URL
      .then((res) => {
      ...
      >
        {({
          ...
          <form onSubmit={handleSubmit}>
            <Card sx={{ p: 4, borderRadius: 3, backgroundColor: "#fff" }}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={8}>
                    <Card sx={{ p: 4, borderRadius: 3, boxShadow: 3 }}>
                      ...
                      <Card
                        variant="outlined"
                        sx={{ borderRadius: 2, p: 3, boxShadow: 2 }}
                      >
                        <CardContent>
                          <Divider sx={{ mb: 3 }} />
                      ...
                      >
                        ...
                        >
                          ...
                          <Grid item>
                            <ArrowForwardIcon
                              sx={{ fontSize: 30, color: "grey.600", mx: 5 }}
                            />
                          </Grid>
                      ...
                      <Box mt={4} display="flex" gap={2} flexWrap="wrap">
                        ...
                        >
                          <span>
                            {" "}
                            {/* span wrapper is required for disabled buttons */}
                            <Button
                              variant="outlined"
                              color="success"
                        ...
                        <Tooltip
                          title={
                            activeStep !== 2
                              ? "Please complete order first"
                              : ""
                          }
                        >
                          <span>
                            {" "}
                            {/* span wrapper is needed because disabled Button blocks pointer events */}
                            <Button
                              variant="contained"
                              color="primary"
                      ...
                      <Box mt={3} pt={2} borderTop="1px dashed #ccc">
                        <Box display="flex" justifyContent="space-between">
                          ...
                          >
                            ₹{" "}
                            {(
                              Number(order?.freight_charge) -
                              Number(order?.hiring_cost)
                            ).toFixed(2)}
                          </Typography>
                        </Box>
                      </Box>
                      ...
                      >
                        ...
                        {order?.pod ? (
                          <Button
                            ...
                            onClick={() =>
                              window.open(
                                `http://127.0.0.1:8000/storage/${order.pod}`,
                                "_blank"
                              )
                            }
                          >
              ...
              >
                ...
                <DialogActions>
                  ...
                  <Button variant="contained" onClick={() => handlePod()}>
                    Upload
                  </Button>
                </DialogActions>
              </Dialog>
              ...
              {activeTab === 1 && (
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={8}>
                    ...
                    <Card
                      variant="outlined"
                      sx={{ mb: 4, borderRadius: 3, boxShadow: 3 }}
                    >
                      <CardHeader
                        title="Party Amount"
                      ...
                      <CardContent>
                        ...
                        >
                          ...
                          <Box display="flex" alignItems="center" gap={1}>
                            <Typography color="primary" fontWeight={600}>
                              ₹ {order?.freight_charge || 0}
                            </Typography>
                            <Button
                              size="small"
                              onClick={() =>
                                handleOpenAmountEdit("Party", values.Party)
                              }
                            >
                              ✏️
                            </Button>
                        ...
                        <Box pl={2} mb={2}>
                          ...
                          {order?.PartyPayments?.advance_details?.map(
                            (oneOrder, index) => (
                              <Box
                                key={index}
                                mt={2}
                              ...
                              >
                                ...
                                >
                                  <Typography fontWeight={700}>
                                    Advance Party Balance
                                  </Typography>
                                  <Typography color="primary" fontWeight={700}>
                                    ₹
                                    {parseFloat(
                                      oneOrder.advance_amount || 0
                                    ).toFixed(2)}
                                  </Typography>
                                </Box>
                                <Typography
                        ...
                        <Box pl={2} mb={2}>
                          ...
                          {order?.PartyPayments?.additional_charges?.map(
                            (oneOrder, index) => (
                              <Box
                                key={index}
                                mt={2}
                        ...
                        >
                          ...
                          <Typography color="primary" fontWeight={700}>
                            ...
                            {(
                              ...
                              (order?.PartyPayments?.additional_charges?.reduce(
                                (sum, item) => {
                                  return (
                                    sum + (Number(item.additional_charge) || 0)
                                  );
                                },
                                0
                              ) || 0) -
                              // Step 1: Sum all advance_amount values
                              (order?.PartyPayments?.advance_details?.reduce(
                                (sum, item) => {
                                  return (
                                    sum + (Number(item.advance_amount) || 0)
                                  );
                                },
                                0
                              ) || 0)
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <Box pl={2} mb={2}>
                          ...
                          {order?.SupplierPayments?.advance_details?.map(
                            (oneOrder, index) => (
                              <Box
                                key={index}
                                mt={2}
                        ...
                        <Box pl={2} mb={2}>
                          ...
                          {order?.SupplierPayments?.additional_charges?.map(
                            (oneOrder, index) => (
                              <Box
                                key={index}
                                mt={2}
                        ...
                        >
                          ...
                          <Typography color="primary" fontWeight={700}>
                            ...
                            {(
                              ...
                              (order?.SupplierPayments?.additional_charges?.reduce(
                                (sum, item) => {
                                  return (
                                    sum + (Number(item.additional_charge) || 0)
                                  );
                              ...
                              // Step 1: Sum all advance_amount values
                              (order?.SupplierPayments?.advance_details?.reduce(
                                (sum, item) => {
                                  return (
                                    sum + (Number(item.advance_amount) || 0)
                                  );
                      ...
                      <Box mt={3} pt={2} borderTop="1px dashed #ccc">
                        <Box display="flex" justifyContent="space-between">
                          ...
                          <Typography
                            ...
                            fontSize={24}
                          >
                            ₹ {order?.freight_charge - order?.hiring_cost}
                          </Typography>
                        </Box>
                      </Box>
                    </Card>
            ...
            {/* Amount Edit Modal */}
            <Dialog
              open={openAmountEditModal}
              onClose={() => setOpenAmountEditModal(false)}
              maxWidth="xs"
              fullWidth
            >
              ...
              <DialogActions>
                <Button onClick={() => setOpenAmountEditModal(false)}>
                  Cancel
                </Button>
                <Button variant="contained" onClick={() => handleEditAmount()}>
                  Save
                </Button>
              </DialogActions>
            </Dialog>
                ...
                {currentList.map((adv, idx) => (
                  <div key={idx} style={{ marginTop: 12 }}>
                    ...
                    <TextField
                      ...
                      value={
                        isParty
                          ? partyAdvances[idx]?.advance_date || ""
                          : supplierAdvances[idx]?.advance_date
                      }
                      onChange={(e) =>
                        handleAdvanceChange(
                          currentType,
                    ...
                    <TextField
                      ...
                      value={
                        isParty
                          ? partyAdvances[idx]?.advance_note || ""
                          : supplierAdvances[idx]?.advance_note || ""
                      }
                      onChange={(e) =>
                        handleAdvanceChange(
                          currentType,
                    ...
                    <TextField
                      ...
                      value={
                        isParty
                          ? partyAdvances[idx]?.advance_amount || ""
                          : supplierAdvances[idx]?.advance_amount || "q"
                      }
                      onChange={(e) =>
                        handleAdvanceChange(
                          currentType,
            ...
            >
              <DialogTitle>
                Add {chargeType === "party" ? "Party" : "Supplier"} Charge
              </DialogTitle>
              <DialogContent sx={{ pt: 2 }}>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    handleChargeChange("description", e.target.value)
                  }
                />
              </DialogContent>
              <DialogActions>
