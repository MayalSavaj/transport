...
export default function BrandList({
  ...
  return <Box py={4}>
      ...
      <SearchArea handleSearch={() => {}} buttonText="Add Brand" searchPlaceholder="Search Brand..." handleBtnClick={() => Router.push("/admin/suppliers/create")} />
        ...
        <Scrollbar>
          ...
          minWidth: 600
            ...
            <Table>
              ...
              <TableBody>
                {filteredList.map(brand => <suppliersRow brand={brand} key={brand.id} selected={selected} />)}
              </TableBody>
            </Table>
          </TableContainer>
        </Scrollbar>
